...
{
    /// <inheritdoc />
    public partial class ProjetSpliting : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AlertProduct", x => new { x.AlertsId, x.ProductsId });
                    table.ForeignKey(
                        name: "FK_AlertProduct_Alerts_AlertsId",
                        column: x => x.AlertsId,
                        principalTable: "Alerts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AlertProduct_Products_ProductsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AlertProduct_ProductsId",
                table: "AlertProduct",
                column: "ProductsId");
